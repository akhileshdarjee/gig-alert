<div class="panel-body">
	<div class="row">
		<div class="col-md-12" id="venue-details">
			<h4>
				<strong><i class="fa fa-map-marker"></i> Venue Details</strong>
			</h4>
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-4 media">
							...
							@if (isset($form_data['tabVenue']['avatar']) && $form_data['tabVenue']['avatar'])
								<img src="{{ $form_data['tabVenue']['avatar'] }}" alt="{{ $form_data['tabVenue']['name'] }}">
							@else
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="city" id="city" class="form-control" data-mandatory="no" autocomplete="off">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="lat" id="lat" class="form-control" data-mandatory="no" autocomplete="off">
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="long" id="long" class="form-control" data-mandatory="no" autocomplete="off">
						</div>
					</div>
				</div>
			</div>
