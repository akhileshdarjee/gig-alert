                      ...
                      <td class="block-rounded">
                        <table cellpadding="0" cellspacing="0" width="100%">
                              ...
                              <table cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                  <td style="text-align:left; width:155px">
                                    <a href=""><span class="header-sm">{{ $data['name'] }}</span></a><br />
                          ...
                          <tr>
                            <td style="padding: 15px;">
                              <div>
                              <a class="button-width" href="{{ $data['ticket_link'] }}"
                              style="background-color:#6f5499;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;mso-hide:all;">Get Ticket!</a></div>
                            </td>
                          </tr>
                        </table>
                      </td>
